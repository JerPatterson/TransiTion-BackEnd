...
export class TimeService {
  ...
  async getTodayTimesFromRoute(agencyId: string, routeId: string) {
    const tripsIds = await this.tripService.getTodayTripsFromRoute(
      agencyId,
      routeId,
    );
    return (
  ...
  async getYesterdayTimesFromRoute(agencyId: string, routeId: string) {
    const tripIds = await this.tripService.getYesterdayTripsFromRoute(
      agencyId,
      routeId,
    );
    return (
  ...
  async getTomorrowTimesFromRoute(agencyId: string, routeId: string) {
    const tripsIds = await this.tripService.getTomorrowTripsFromRoute(
      agencyId,
      routeId,
    );
    return (
